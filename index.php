    ...
    <div id="idForm">
        <form action="" method="post" novalidate>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="nativecountry" type="text" name="nativecountry" placeholder="EX : FRANCE"
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="address" type="text" name="address" placeholder="EX : 52 Rue de ce petit chemin qui sent la noisette"
            ...
            <div class="form-group col-md-6">
                ...
                <input type="email" class="form-control" id="emailadress" name="emailadress" placeholder="EX : PAULDUPONT@GMAIL.COM"
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="phonenumber" type="text" name="phonenumber" placeholder="EX : 0699999999"
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="poleemploinumber" type="text" name="poleemploinumber" maxlength="8" minlength="8" placeholder="EX : 12345567R"
                    value="<?= isset($_POST['poleemploinumber']) ? $_POST['poleemploinumber'] : '' ?>" required>
                <span class="text-danger"><?= isset($error['poleemploinumber']) ? $error['poleemploinumber'] : '' ?></span>
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control" id="codecademylink" type="text" name="codecademylink" placeholder="EX : https://www.codecademy.com/"
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="experiencequestion" name="experiencequestion" maxlength="400"
                    minlength="60" required>
            </textarea>
            </div>
